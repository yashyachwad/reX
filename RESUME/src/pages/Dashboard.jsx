...
const Dashboard = () => {
  ...
  const fetchAllResumes = async () => {
    try {
      ...
      // Add completion percent to each resume
  ...
  return (
    <DashboardLayout>
          ...
          <div className="flex gap-4">
            <button className={styles.createButton} onClick={() => setOpenCreateModel(true)}>
              ...
              <span className={styles.createButtonContent}>
                Create Now
                <LucideFilePlus className="group-hover:translate-x-1 transition-transform" size={16} />
              </span>
            </button>
          </div>
        </div>
      ...
      <Model
        ...
        actionBtnClassName="bg-red-700"
        onActionClick={handleDeleteResume}
      >
        <div className="p-4">
          <div className="flex flex-col items-center text-center">
            <div className={styles.deleteIconWrapper}>
              <LucideTrash2 className="text-orange-600" size={18} />
            </div>
