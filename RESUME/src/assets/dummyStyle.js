export const landingPageStyles = {
  // Main container
  // container: "min-h-screen bg-gradient-to-br from-stone-300 via-stone-900 to-stone-700",
  container: "min-h-screen bg-[radial-gradient(125%_125%_at_50%_10%,_#000000_40%,_#350136_100%)]",
  // Header styles
  header: "fixed top-0 w-full z-50 bg-[radial-gradient(circle_at_1px_1px,rgba(139,92,246,0.2)_1px,transparent_0),radial-gradient(circle_at_1px_1px,rgba(59,130,246,0.18)_1px,transparent_0),radial-gradient(circle_at_1px_1px,rgba(236,72,153,0.15)_1px,transparent_0)] bg-[length:20px_20px,30px_30px,25px_25px] bg-[position:0_0,10px_10px,15px_5px] bg-[#000000] backdrop-blur-xl border-b border-zinc-500",
  ...
  logoIcon: "w-8 h-8 bg-gradient-to-br from-yellow-600 to-fuchsia-600 rounded-md flex items-center justify-center  ",
  logoIconInner: "w-5 h-5 text-white",
  logoText: "text-xl sm:text-2xl font-black bg-gradient-to-r from-orange-600 to-blue-300 bg-clip-text text-transparent",
  mobileMenuButton: "md:hidden p-2 rounded-xl hover:bg-violet-50 transition-colors",
  mobileMenuIcon: "text-violet-600",

  // Auth buttons
  desktopAuthButton: "relative group px-6 sm:px-4 py-2 sm:py-1 bg-gradient-to-r from-zinc-900 to-orange-300 text-white font-bold rounded-md hover:rounded-full overflow-hidden transition-all ",
  desktopAuthButtonText: "relative",
  mobileAuthButton: "w-full px-6 py-3 bg--to-r from-violet-600 to-fuchsia-600 text-white font-bold rounded-2xl",
  ...
  mobileAuthButton: "w-full px-2 py-1 bg-gradient-to-r from-yellow-600 to-fuchsia-600 text-white font-bold rounded-md hover:shadow-lg hover:shadow-violet-200/50 transition-all",
  // Main content
  main: "pt-10  bg-[radial-gradient(circle_at_1px_1px,rgba(139,92,246,0.2)_1px,transparent_0),radial-gradient(circle_at_1px_1px,rgba(59,130,246,0.18)_1px,transparent_0),radial-gradient(circle_at_1px_1px,rgba(236,72,153,0.15)_1px,transparent_0)] bg-[length:20px_20px,30px_30px,25px_25px] bg-[position:0_0,10px_10px,15px_5px] bg-[#000000] backdrop-blur-xl border-b border-zinc-500",
 ...
 heroGrid: "flex flex-col md:flex-row justify-between items-center gap-10 lg:gap-12",
  heroLeft: "space-y-8",
  ...
  heading: "text-4xl sm:text-4xl lg:text-6xl font-black leading-tight",
  headingText: "block text-slate-600",
  headingGradient: "block bg-gradient-to-r from-yellow-600 via-fuchsia-600 to-orange-500 bg-clip-text text-transparent",
  description: "text-base sm:text-lg lg:text-xl text-slate-600 leading-relaxed max-w-lg font-medium",
  ctaButtons: "flex flex-col sm:flex-row gap-4 justify-center items-center",

  // Buttons
  primaryButton: "group relative w-full sm:w-auto px-7 lg:px-4 py-2 bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-bold rounded-md hover:rounded-full overflow-hidden transition-all   duration-[1500ms] ease-in-out",
  ...
  secondaryButton: "w-full sm:w-auto px-5 sm:px-10 ml-4 sm:ml-16 py-2 sm:py-2 border-2 border-violet-200 text-violet-700 font-bold rounded-md hover:rounded-full hover:border-violet-300 hover:bg-violet-50 transition-all",
  ...
  svgRect: "fill-[url(#cardGradient)] stroke-[#e2e8f0] stroke-[1]",
  ...
  // Features section
  featuresSection: "bg-[radial-gradient(circle_at_1px_1px,rgba(139,92,246,0.2)_1px,transparent_0),radial-gradient(circle_at_1px_1px,rgba(59,130,246,0.18)_1px,transparent_0),radial-gradient(circle_at_1px_1px,rgba(236,72,153,0.15)_1px,transparent_0)] bg-[length:20px_20px,30px_30px,25px_25px] bg-[position:0_0,10px_10px,15px_5px] bg-[#000000] backdrop-blur-xl border-b border-zinc-500 py-16 sm:py-24 mt-16",
  ...
  featureCardContent: "relative bg-gradient-to-br border border-white/50 p-6 sm:p-8 rounded-3xl hover:shadow-md transition-all group-hover:scale-105",
  featureIconContainer: "w-12 h-12 sm:w-20 sm:h-20 bg-gradient-to-br rounded-md flex items-center justify-center mb-4 sm:mb-6 text-white shadow-lg",
  featureIcon: "w-8 h-8 sm:w-10 sm:h-10",
  featureTitle: "text-xl sm:text-2xl font-black text-slate-600 mb-2 sm:mb-4",
  ...
  ctaCard: "relative",
  ctaCardBg: "absolute -inset-6 sm:-inset-8 bg-gradient-to-r  rounded-3xl blur-3xl",
  ctaCardContent: "relative bg-gradient-to-br from-purple-500 to-yellow-500 border border-violet-100 rounded-3xl p-8 sm:p-16",
  ...
  ctaButton: "group relative px-2 sm:px-12 py-2 sm:py-4 bg-gradient-to-r from-blue-200 to-orange-300 text-white font-black text-md rounded-md overflow-hidden transition-all  ",
...
export const dashboardStyles = {
  // Container
  container: "container mx-auto px-4 py-6 bg-[radial-gradient(circle_at_1px_1px,rgba(139,92,246,0.2)_1px,transparent_0),radial-gradient(circle_at_1px_1px,rgba(59,130,246,0.18)_1px,transparent_0),radial-gradient(circle_at_1px_1px,rgba(236,72,153,0.15)_1px,transparent_0)] bg-[length:20px_20px,30px_30px,25px_25px] bg-[position:0_0,10px_10px,15px_5px] bg-[#000000] backdrop-blur-xl border-b border-zinc-500",

  // Header
  headerWrapper: "flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6",
  headerTitle: "text-2xl font-bold text-yellow-100",
  headerSubtitle: "text-gray-600",

  // Create Button
  createButton: "group relative px-10 py-4 bg-gradient-to-r from-yellow-300 to-yellow-50 text-zinc-800 font-bold rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-2xl hover:shadow-violet-200",
  ...
  // New Resume Card
  newResumeCard: "flex flex-col items-center justify-center bg-gradient-to-br from-red-200 to-blue-50 border-2 border-dashed border-violet-300 rounded-2xl p-6 cursor-pointer transition-all hover:shadow-lg hover:border-violet-500 h-full",
  ...
  modalCloseButton: "text-red-500 hover:text-red-700",
...
export const cardStyles = {
  ...
  profileCard: "flex items-center gap-3 p-1 sm:px-3 bg-white   backdrop-blur-xl rounded-md shadow-sm hover:shadow-lg transition-all duration-300 hover:scale-[1.03]",
  profileInitialsContainer: "w-8 h-8 sm:w-7 sm:h-7 text-md bg-gradient-to-br from-violet-500 to-fuchsia-500 rounded-2xl flex items-center justify-center shadow-md",
  profileInitialsText: "text-base  sm:text-md font-black text-white",
  profileName: "text-xs sm:text-sm font-bold text-gray-800",
  logoutButton: "text-violet-600 text-[9px] sm:text-xs font-bold cursor-pointer hover:text-fuchsia-600 transition-colors",
...
export const containerStyles = {
  main: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 bg-[radial-gradient(circle_at_1px_1px,rgba(139,92,246,0.2)_1px,transparent_0),radial-gradient(circle_at_1px_1px,rgba(59,130,246,0.18)_1px,transparent_0),radial-gradient(circle_at_1px_1px,rgba(236,72,153,0.15)_1px,transparent_0)] bg-[length:20px_20px,30px_30px,25px_25px] bg-[position:0_0,10px_10px,15px_5px] bg-[#000000] backdrop-blur-xl border-b border-zinc-500",
  header: "  flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-gradient-to-r from-pink-200 to-transparent border border-violet-100 rounded-2xl py-4 px-6 mb-6 shadow-sm",
...
export const buttonStyles = {
  theme: "flex items-center gap-1 sm:gap-3 px-2 sm:px-4 py-2 bg-violet-100 text-violet-700 font-bold rounded-xl hover:bg-violet-200 transition-all",
  delete: "flex items-center gap-1 sm:gap-3 px-2  sm:px-4 py-2 bg-red-100 text-red-700 font-bold rounded-xl hover:bg-red-200 transition-all",
  download: "flex items-center gap-1 sm:gap-3 px-2  sm:px-4 py-2 bg-emerald-100 text-emerald-700 font-bold rounded-xl hover:bg-emerald-200 transition-all",
  back: "flex items-center gap-2 px-3 sm:px-6 py-1 sm:py-3 sm:border bg-gradient-to-r from-red-200 to- text-gray-200 font-bold rounded-md hover:bg-gray-200 transition-all text-sm",
  save: "flex items-center gap-2 px-3 sm:px-6 py-1 sm:py-3 bg-green-400 text-blue-700 font-bold rounded-md hover:bg-blue-200 transition-all text-sm",
  next: "flex items-center gap-2 px-3 sm:px-6 py-1 sm:py-3  bg-gradient-to-l from-yellow-500 to- text-white font-bold rounded-md hover:scale-105 transition-all shadow-lg text-sm",
